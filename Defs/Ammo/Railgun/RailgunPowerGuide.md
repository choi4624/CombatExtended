...
| Caliber d (mm) | Penetration P6 (mm RHA) | Energy/Shot E6 (Wh) | Cells @100% (min) | Cells @50% | Cells @30% |
|----------------|--------------------------|----------------------|-------------------|------------|------------|
| 2.0            | 17.9                     | 0.70                 | 1                 | 1          | 1          |
...
| Caliber d (mm) | Penetration P8 (mm RHA) | Energy/Shot E8 (Wh) | Cells @100% (min) | Cells @50% | Cells @30% |
|----------------|--------------------------|----------------------|-------------------|------------|------------|
| 2.0            | 24.6                     | 1.25                 | 1                 | 1          | 1          |
